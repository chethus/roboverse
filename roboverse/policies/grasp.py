...
class CustomGrasp(RotateGrasp):
    obj_yaws = {
        ...
        'flat_bottom_sack_vase': -140,
        'trapezoidal_bin': -105,
        'vintage_canoe': 105,
        'bathtub': 95,
        'flowery_half_donut': -105,
        't_cup': -155,
        'cookie_circular_lidless_tin': 115,
        'box_sofa': -95,
        ...
        'thick_wood_chair': -120,
        'curved_handle_cup': 115,
        'baseball_cap': 125,
        'elliptical_capsule': 110,
    }
    def reset(self):
        super().reset()
        self.pick_angles[-1] = CustomGrasp.obj_yaws[self.env.target_object]
